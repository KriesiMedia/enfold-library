		...
		public function rel_to_abs_url( $content, $path )
		{
			...
			return $content;
				...
				public function _url_callback( $match )
				{
					...
					{
						/**
						 * Cross server references currently must be returned with http: because it had been removed in avia_style_generator::create_styles
						 */
