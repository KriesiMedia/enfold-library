...
//			$output .=			"<a class='avia-new-target'  href='#new-target' title='" . __( 'Move Section','avia_framework' ) . "'>+</a>";
		...
		protected function get_element_styles( array $args )
		{
			...
			//	Style background
			$atts['src'] = '';
			if( ! empty( $atts['attachment'] ) && ! empty( $atts['attachment_size'] ) )
			{
				/**
			...
			if( $atts['src'] != '' )
			{
				...
				$styles = array(
							...
							'background-position' => $atts['position'],
...
//			$args['atts']['padding'] = '';
		...
		function shortcode_handler( $atts, $content = '', $shortcodename = '', $meta = '' )
		{
			...
			$params['class'] = $element_styling->get_class_string( 'section-outer' ) . ' ' . $av_display_classes;
