...
if( ! class_exists( 'avia_responsive_images' ) )
{
	...
	class av_responsive_images 
	{
		...
		{
			$active = 'responsive_images' == avia_get_option( 'responsive_images', '' );
			 ...
			 * @return boolean
			 */
			return apply_filters( 'avf_responsive_images_active', $active );
		}
		...
		{
			$active = 'responsive_images_lightbox' == avia_get_option( 'responsive_images_lightbox', '' );
			 ...
			 * @return boolean
			 */
			return apply_filters( 'avf_responsive_images_lightbox_active', $active );
		}
