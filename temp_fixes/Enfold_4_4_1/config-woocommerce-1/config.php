...
add_filter( 'woocommerce_product_get_image', 'my_widget_product_image_size', 10, 6 );
...
if( ! function_exists( $function_name) )
{
	 ...
	 * @return string
	 */
	function my_widget_product_image_size( $image, $product, $size, $attr, $placeholder, $image1 )
	{
