...
//			$params['innerHtml'] .= '</div>';
		...
		protected function get_element_styles( array $args ) 
		{
			...
			if( ! isset( avia_sc_masonry_entries::$obj_masonry[ $element_id ] ) )
			{
				avia_sc_masonry_entries::$obj_masonry[ $element_id ] = new avia_masonry( $atts );
			}
			
			$masonry = avia_sc_masonry_entries::$obj_masonry[ $element_id ];
