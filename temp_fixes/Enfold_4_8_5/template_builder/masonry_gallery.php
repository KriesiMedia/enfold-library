...
if ( ! class_exists( 'avia_sc_masonry_gallery' ) ) 
{
	...
	{	
		 ...
		 * @var array
		 */
		static protected $obj_masonry = array();
		...
		protected function register_dynamic_templates()
		{
			...
			$c = array(
						...
						array(
							...
							'desc'		=> __( 'Select a size for each image. Default setting by theme is &quot;Masonry&quot;', 'avia_framework' ),
							'id'		=> 'image_size',
							'type'		=> 'select',
							'std'		=> 'masonry',
							'lockable'	=> true,
...
//			$params['innerHtml'] .= '</div>';
		...
		protected function get_element_styles( array $args ) 
		{
			...
			if( ! isset( avia_sc_masonry_gallery::$obj_masonry[ $element_id ] ) )
			{
				avia_sc_masonry_gallery::$obj_masonry[ $element_id ] = new avia_masonry( $atts );
			}
			
			$masonry = avia_sc_masonry_gallery::$obj_masonry[ $element_id ];
		...
		public function ajax_load_more( array $atts ) 
		{
			...
			$output = $masonry->html( $element_styling, $element_id, $this );
		...
		function shortcode_handler( $atts, $content = '', $shortcodename = '', $meta = '' )
		{
			...
			{
				$masonry->atts['custom_class'] = '';
				$masonry->atts['id'] = '';
			}
			
			$masonry_html = $masonry->html( $element_styling, $element_id, $this );
